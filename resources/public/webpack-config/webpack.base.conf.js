...
const PATHS = {
  ...
  dist: path.join(__dirname, '../../../public/public'),
  assets: path.join(__dirname, '../assets'),
  html: path.join(__dirname, '../pages'),
...
module.exports = {
  ...
  output: {
    filename: `${PATHS.destinationAssets}js/[name].[contenthash].js`,
    path: PATHS.dist,
    /*
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({
      filename: `${PATHS.destinationAssets}css/[name].[contenthash].css`
    }),
    new CopyWebpackPlugin({
      patterns: [
        // Images:
        {
          ...
          to: `${PATHS.destinationAssets}img`
        },
        // Fonts:
        {
          from: `${PATHS.assets}/fonts`,
          to: `${PATHS.destinationAssets}fonts`
        },
        // Static (copy to '/'):
        /*{
